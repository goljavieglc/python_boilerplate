...
Report bugs at [here](https://github.com/goljavi/python_boilerplate/issues).
...
The best way to send feedback is to file an [issue](https://github.com/goljavi/python_boilerplate/issues).
...
3. The pull request should work for Python 2.7, 3.4, 3.5 and 3.6, and for PyPy. Check
   [Travis test](https://travis-ci.org/goljavi/python_boilerplate/pull_requests)
